...
$messages['en'] = array(
	...
	'gwtoolset-step-3-instructions-3' => 'If you’re not happy with the results, go back to Step 2: Metadata mapping and adjust the mapping as necessary.<br />If you need to make adjustments to the metadata file itself, go ahead and do so and re-upload it by beginning the process again with Step 1: Metadata detection.',
	 ...
	 * wiki checks
	 */
	'gwtoolset-maxuploadsize-exceeds-ini-settings' => 'The PHP ini settings:<br />• <code>upload_max_filesize</code> ( $1 )<br /> • <code>post_max_size</code> ( $2 )<br /><br />are set lower than the wiki’s $wgMaxUploadSize ( $3 ); please adjust the PHP ini settings as appropriate.',
...
$messages['qqq'] = array(
	...
	'gwtoolset-metadata-invalid-template' => 'appears when No valid MediaWiki template found',
	...
	'gwtoolset-step-1-instructions-1' => 'first instructions paragraph',
	'gwtoolset-step-1-instructions-2' => 'second instructions paragraph',
	'gwtoolset-step-1-instructions-li-1' => 'first step',
	'gwtoolset-step-1-instructions-li-2' => 'second step',
	'gwtoolset-step-1-instructions-li-3' => 'third step',
	'gwtoolset-step-1-instructions-li-4' => 'fourth step',
	...
	'gwtoolset-step-2-instructions-heading' => 'instructions heading',
	'gwtoolset-step-2-instructions-1' => 'first set of instructions',
	'gwtoolset-step-2-instructions-1-li-1' => 'first instuction',
	'gwtoolset-step-2-instructions-1-li-2' => 'second instruction',
	'gwtoolset-step-2-instructions-1-li-3' => 'third instruction',
	'gwtoolset-step-2-instructions-2' => 'second set of instructions',
	'gwtoolset-step-2-instructions-2-li-1' => 'first instruction',
	'gwtoolset-step-2-instructions-2-li-2' => 'second instruction',
	'gwtoolset-template-field' => 'label for the HTML form',
	'gwtoolset-step-3-instructions-heading' => 'heading and instructions for step 3',
	'gwtoolset-step-3-instructions-1' => 'instructions for step 3',
